...
<body>
    <?php $url=base_url("Admin/Register"); ?>
                ...
                <ul class="responsive-table">
                    <table>
                        ...
                        <tbody>
                            ...
                            echo "<div class='col col-1' data-label='#'>".$admin['user_id']."</div>";
                            echo "<div class='col col-2' data-label='Admin Name'>".$admin['first_name']." ".$admin['last_name']."</div>";
                            echo "<div class='col col-3' data-label='Email'>".$admin['email']."</div>";
                            echo "<div class='col col-4' data-label='Price'>".$admin['gender']."</div>";
                            echo "<div class='col col-5' data-label='Action'><button type='submit' class='actionbtn' title='Edit item' value='".$admin['user_id']."'><i class='fas fa-pen'></i></button><button type='submit' title='Delete item' class='actionbtn' value='".$admin['user_id']."'><i class='fas fa-trash-alt'></i></button></div>";
                            echo "</li>";
                            }
                            ?>
                        </tbody>
