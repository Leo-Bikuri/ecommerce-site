                ...
                <ul class="responsive-table">
                    <table>
                        ...
                        <tbody>
                            ...
                            echo "<div class='col col-1' data-label='#'>".$client['user_id']."</div>";
                            echo "<div class='col col-2' data-label='Admin Name'>".$client['first_name']." ".$client['last_name']."</div>";
                            echo "<div class='col col-3' data-label='Email'>".$client['email']."</div>";
                            echo "<div class='col col-4' data-label='Price'>".$client['gender']."</div>";
                            echo "<div class='col col-5' data-label='Action'><button type='submit' class='actionbtn' title='Edit item' value='".$client['user_id']."'><i class='fas fa-pen'></i></button><button type='submit' title='Delete item' class='actionbtn' value='".$client['user_id']."'><i class='fas fa-trash-alt'></i></button></div>";
                            echo "</li>";
                            }
                            ?>
                        </tbody>
