                ...
                <div class="table-responsive">
                  <table class="table tablesorter " id="">
                    ...
                    <tbody>
                      ...
                      <a href="/administrator/<?= $admin['user_id'] ?>"><tr class="table_row" id="<?= $admin['user_id'] ?>" onclick = "window.location.href='/administrator/<?= $admin['user_id'] ?>'">
                        <td>
                          <?= $admin['user_id'] ?>
                        </td>
                        <td>
                        ...
                        <button title='Delete item' class='actionbtn' value="" onclick="deleteUser('<?= $admin['user_id'] ?>'); "><i class='fas fa-trash-alt'></i></button>
                        </td>
                      </tr>
                      <?php }?>
                    </tbody>
    ...
    function deleteUser(id){
        $.ajax({
            ...
            success: function(response){
                if(response == "success"){
                    demo.showNotification("top", "center", "success", "Successfully deleted user");
